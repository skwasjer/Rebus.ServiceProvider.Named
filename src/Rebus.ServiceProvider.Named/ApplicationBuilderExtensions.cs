...
namespace Rebus.ServiceProvider.Named
{
    ...
    public static class ApplicationBuilderExtensions
    {
		...
		/// <returns>The application builder to continue chaining configuring the request pipeline.</returns>
		public static IApplicationBuilder UseTypedRebus<TName>(this IApplicationBuilder applicationBuilder, Action<INamedBus> configureBus)
            where TName : class
        {
		...
		/// <param name="configureBus">A delegate to configure the bus.</param>
		/// <returns>The application builder to continue chaining configuring the request pipeline.</returns>
		public static IApplicationBuilder UseNamedRebus(this IApplicationBuilder applicationBuilder, string name, Action<INamedBus> configureBus)
        {
